    ...
    return (
        <>
            <section className=" p-7 h-screen w-full bg-[url(./taxi-booking.jpg)] bg-cover bg-center">
                ...
                <h1 className="text-4xl font-bold drop-shadow-lg text-center mb-8">User Sign-Up</h1>
                ...
                <div className="flex flex-col items-center gap-8">
                    ...
                    {/* Additional Options */}
                    <div className="flex flex-col items-center justify-center mt-50 backdrop-blur-md bg-white/30 shadow-xl rounded-xl p-6 w-full max-w-md">
